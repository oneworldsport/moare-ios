...
@Reducer
struct MLBPlayerStatsStore {
    typealias BaseStats = BaseStatsStore<MLBPlayerStatsDisplayModel>
    
    @ObservableState
    struct State {
        var baseStats: BaseStats.State
        
        init(displayModel: MLBPlayerStatsDisplayModel) {
