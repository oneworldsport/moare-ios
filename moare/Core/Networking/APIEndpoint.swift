...
enum APIEndpoint {
    ...
    var defaultHTTPMethod: String {
        switch self {
        case .searchByQuery, .searchByEndpoint, .fetchTrendingKeywords, .searchById, .bootstrapSession, .checkNickname, .getMoatDetail, .getUserProfile, .checkFire:
            return "GET"
...
//        components.host = APIConfiguration.host
    ...
    var httpBody: Data? {
        switch self {
        case .bootstrapSession, .searchByQuery, .searchByEndpoint, .fetchTrendingKeywords, .searchById, .checkNickname, .deleteMoat, .getMoatDetail, .getUserProfile, .deleteFire, .checkFire:
            return nil
